// Cursor trail / smear shader for Ghostty
// Source: github.com/sahaj-b/ghostty-cursor-shaders (cursor_tail.glsl)
// Draws an animated trail between the previous and current cursor
// position using Ghostty's cursor uniforms.
